...
module.exports = require("libphonenumber-js/max");
...
var _mainvue_type_template_id_247f3a44_render = function() {
  ...
  return _c(
    ...
    _vm._b(
      {
        tag: "component",
        staticClass: "maz-base-component maz-btn",
        class: [
          _vm.classes,
          {
            hidden: _vm.loading
          },
          _vm.justifyStart ? "maz-justify-start" : null
        ],
        attrs: {
          id: _vm.uniqueId,
...
/* harmony default export */ var MazBtn_mainvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    classes: function classes() {
      ...
      return [].concat(_toConsumableArray(color ? ["maz-btn--".concat(color)] : [null]), _toConsumableArray(size ? ["maz-btn--".concat(size)] : [null]), _toConsumableArray(outline ? ["maz-btn--".concat(color, "--outline")] : [null]), _toConsumableArray(rounded ? ['maz-btn--rounded'] : [null]), _toConsumableArray(block ? ['maz-btn--block'] : [null]), _toConsumableArray(fab ? ['maz-btn--fab maz-dots-text'] : [null]), _toConsumableArray(isDisabled ? ['maz-btn--disabled'] : [null]), _toConsumableArray(active ? ['maz-active'] : [null]), _toConsumableArray(noShadow ? ['maz-no-shadow'] : [null]), _toConsumableArray(hasLeftIcon() ? ['maz-btn--icon--left'] : [null]), _toConsumableArray(hasRightIcon() ? ['maz-btn--icon--right'] : [null]), _toConsumableArray(hasIcon() ? ['maz-btn--icon'] : [null]));
    }
  },
  methods: {
        ...
        _vm._b(
          {
            ...
            attrs: { active: val === _vm.value, rounded: _vm.rounded },
            on: {
              click: function($event) {
    ...
    [
      _c(
        "MazBtn",
        {
          ...
          attrs: { color: _vm.dark ? "dark" : "white", size: "md" },
...
/* harmony default export */ var MazDialog_mainvue_type_script_lang_js_ = ({
  ...
  computed: {
    widthStyle: function widthStyle() {
      ...
      return {
        maxWidth: fullsize ? null : "".concat(maxWidth, "px")
      };
    },
...
var _mainvue_type_template_id_5b617c72_render = function() {
  ...
  return _c(
    ...
    {
      ref: "parent",
      staticClass: "maz-base-component maz-input",
      class: [
        {
            ...
            _vm._b(
              {
                ...
                ref: "MazInput",
                staticClass:
                  "maz-input__input maz-border maz-border-color maz-border-color-hover maz-border-solid",
                class: {
                  "has-right-icon":
            ...
            _vm._b(
              {
                ...
                ref: "MazInput",
                staticClass:
                  "maz-input__input maz-textarea maz-border maz-border-color maz-border-color-hover maz-border-solid",
                attrs: {
                  id: _vm.uniqueId,
                  placeholder: _vm.placeholderValue,
                  type: _vm.type,
...
/* harmony default export */ var MazInput_mainvue_type_script_lang_js_ = ({
  ...
  props: {
    ...
    value: {
      required: true,
      validator: function validator(prop) {
        return ['number', 'string'].includes(MazInput_mainvue_type_script_lang_js_typeof(prop)) || prop === null;
      }
    },
    // input id
    id: {
  ...
  computed: {
    inputValue: {
      ...
      set: function set(value) {
        ...
        // @arg input
        this.$emit('input', this.hasNumberType ? !value ? 0 : parseInt(value) : value);
      }
    },
          ...
          _vm.hasPickerOpen
            ? _c("PickersContainer", {
                ...
                attrs: {
                  ...
                  "min-date": _vm.minDateMoment,
                  "max-date": _vm.maxDateMoment,
...
/* harmony default export */ var MonthPickervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    isDisabled: function isDisabled(day) {
      return day.isBefore(this.minDate) || day.isAfter(this.maxDate) || this.noWeekendsDays && this.isWeekEndDay(day) || this.isDateDisabled(day) || this.isDayDisabledWeekly(day);
    },
              ...
              _vm._l(column.items, function(item) {
                return _c(
                  "MazBtn",
                  {
                    key: item.item,
                    staticClass:
                      "time-picker__column__item maz-flex maz-flex-center maz-bg-transparent maz-text-color maz-p-0",
                    attrs: {
                      size: "mini",
                      "no-shadow": !_vm.isActive(column.type, item.value),
                      tabindex: "-1",
                    ...
                    on: {
                      click: function($event) {
                        item.disabled
                          ? null
                          : _vm.setTime(item.value, column.type)
                      }
                    }
                  },
                  [_vm._v("\n        " + _vm._s(item.item) + "\n      ")]
...
var scrollSmoothElement = function scrollSmoothElement(elem, parentHeight, hasSmoothEffect) {
  ...
  if (selected) {
    ...
    if (boundsSelected && boundsElem) {
      var scrollValue = ITEM_HEIGHT / 2 + boundsSelected.top - boundsElem.top - parentHeight / 2;
      elem.scrollBy({
        top: scrollValue,
...
/* harmony default export */ var TimePickervue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    minTime: function minTime() {
      var _this$minDate$format, _this$minDate;

      return (_this$minDate$format = (_this$minDate = this.minDate) === null || _this$minDate === void 0 ? void 0 : _this$minDate.format(this.timeFormat)) !== null && _this$minDate$format !== void 0 ? _this$minDate$format : null;
    },
    maxTime: function maxTime() {
      var _this$maxDate$format, _this$maxDate;

      return (_this$maxDate$format = (_this$maxDate = this.maxDate) === null || _this$maxDate === void 0 ? void 0 : _this$maxDate.format(this.timeFormat)) !== null && _this$maxDate$format !== void 0 ? _this$maxDate$format : null;
    },
    hours: function hours() {
      var twoDigit = this.timeFormat.includes('hh') || this.timeFormat.includes('HH');
      var isAfternoon = this.apm ? this.apm === 'pm' || this.apm === 'PM' : false;
      var minH = this.isTwelveFormat ? 1 : 0;
      var maxH = this.isTwelveFormat ? 12 : 23;
      return ArrayHourRange(minH, maxH, twoDigit, isAfternoon, this._disabledHours);
    },
    minutes: function minutes() {
      var twoDigit = this.timeFormat.includes('mm') || this.timeFormat.includes('MM');
    ...
    apms: function apms() {
      ...
      return this.isTwelveFormat ? this.timeFormat.includes('A') ? upper : lower : null;
    },
    apm: function apm() {
      if (!this.apms) return null;
      return this.hour > 12 ? this.apms.length > 1 ? this.apms[1].value : this.apms[0].value : this.apms[0].value;
    },
    columns: function columns() {
      return [{
        ...
        type: 'minutes',
        items: this.minutes
      }].concat(TimePickervue_type_script_lang_js_toConsumableArray(this.apms ? [{
        type: 'apms',
        items: this.apms
      }] : []));
    },
    _disabledHours: function _disabledHours() {
      ...
      if (this.minTime) {
        minEnabledHour = this.isTwelveFormat ? this.minTime.toUpperCase().includes('AM') ? external_moment_default()(this.minTime, 'h:mm a').format('h') : parseInt(external_moment_default()(this.minTime, 'h:mm a').format('h')) + 12 : external_moment_default()(this.minTime, 'HH:mm').format('HH');
      }

      if (this.maxTime) {
        maxEnabledHour = this.isTwelveFormat ? this.maxTime.toUpperCase().includes('AM') ? external_moment_default()(this.maxTime, 'h:mm a').format('h') : parseInt(external_moment_default()(this.maxTime, 'h:mm a').format('h'), 10) + 12 : external_moment_default()(this.maxTime, 'HH:mm').format('HH');
      ...
      if (minEnabledHour !== 0 || maxEnabledHour !== 23) {
        var enabledHours = TimePickervue_type_script_lang_js_toConsumableArray(Array(24)).map(function (_, i) {
          return i;
        }).filter(function (h) {
        ...
        var _disabledHours = TimePickervue_type_script_lang_js_toConsumableArray(Array(24)).map(function (_, i) {
          return i;
        }).filter(function (h) {
    ...
    _disabledMinutes: function _disabledMinutes() {
      ...
      if (this.isTwelveFormat) {
        ...
        if (this.minTime) {
          ...
          var _minTimeHour = parseInt(external_moment_default()(this.minTime, 'HH:mm').format('HH'), 10);
          ...
          var _maxTimeHour = parseInt(external_moment_default()(this.maxTime, 'HH:mm').format('HH'), 10);
      ...
      if (minEnabledMinute !== 0 || maxEnabledMinute !== 60) {
        var enabledMinutes = TimePickervue_type_script_lang_js_toConsumableArray(Array(60)).map(function (_, i) {
          return i;
        }).filter(function (m) {
        ...
        return TimePickervue_type_script_lang_js_toConsumableArray(Array(60)).map(function (_, i) {
          return i;
        }).filter(function (m) {
  ...
  methods: {
    ...
    onScrollHours: utils_debounce(function (scroll) {
    ...
    onScrollMinutes: utils_debounce(function (scroll) {
      var value = this.getValue(scroll);
    ...
    onScrollApms: utils_debounce(function (scroll) {
      var value = this.getValue(scroll);
    ...
    isMinutesDisabled: function isMinutesDisabled(payload) {
      var m = payload;
      m = m < 10 ? '0' + m : '' + m;
        ...
        return regenerator_default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                if (!_this3.$refs.TimePicker) {
                  _context3.next = 7;
                  break;
                }

                run = function run(pad) {
                  _this3.columnPadding = {
                    height: "".concat(pad, "px")
                  };
                };

                _this3.$nextTick(function () {
                  var _this3$$refs$TimePick, _this3$$refs, _this3$$refs$TimePick2;

                  var pad = ((_this3$$refs$TimePick = (_this3$$refs = _this3.$refs) === null || _this3$$refs === void 0 ? void 0 : (_this3$$refs$TimePick2 = _this3$$refs.TimePicker) === null || _this3$$refs$TimePick2 === void 0 ? void 0 : _this3$$refs$TimePick2.clientHeight) !== null && _this3$$refs$TimePick !== void 0 ? _this3$$refs$TimePick : 100) / 2 - ITEM_HEIGHT / 2;
                  run(pad);
                });
    ...
    setCurrentTime: function setCurrentTime() {
      ...
      var tmpHour = parseInt(this.dateMoment.format('HH'));
    ...
    initPositionView: function initPositionView() {
      ...
      return TimePickervue_type_script_lang_js_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee4() {
        var containers, hasSmoothEffect;
        return regenerator_default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                containers = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : ['hours', 'minutes', 'apms'];
                _context4.next = 3;
                return _this4.$nextTick();

              case 3:
                _this4.noScrollEvent = true; // if (this.apms) containers.push('apms')

                hasSmoothEffect = containers.length === 1;
                _context4.next = 7;
                return _this4.$nextTick();

              case 7:
                containers.forEach(function (container) {
                  var _this4$$refs$TimePick, _this4$$refs$TimePick2;

                  if (!_this4.$refs[container]) return;
                  var elem = _this4.$refs[container][0];
                  var timePickerHeight = (_this4$$refs$TimePick = (_this4$$refs$TimePick2 = _this4.$refs.TimePicker) === null || _this4$$refs$TimePick2 === void 0 ? void 0 : _this4$$refs$TimePick2.clientHeight) !== null && _this4$$refs$TimePick !== void 0 ? _this4$$refs$TimePick : null; // elem.scrollTop = 0

                  scrollSmoothElement(elem, timePickerHeight, hasSmoothEffect);
                });
                setTimeout(function () {
                  _this4.noScrollEvent = false;
                }, 500);
    ...
    emitValue: function emitValue() {
      ...
      this.dateMoment = ((_this$dateMoment = this.dateMoment) !== null && _this$dateMoment !== void 0 ? _this$dateMoment : external_moment_default()()).set({
        hour: hour,
        minute: minute
      });
    }
...
/* harmony default export */ var MazPicker_mainvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    minDateMoment: function minDateMoment() {
      return this.minDate ? external_moment_default()(this.minDate, this.format) : null;
    },
    maxDateMoment: function maxDateMoment() {
      return this.maxDate ? external_moment_default()(this.maxDate, this.format) : null;
    },
  ...
  watch: {
    dateMoment: {
      handler: function handler(value) {
        var minDateMoment = this.minDateMoment,
            maxDateMoment = this.maxDateMoment,
            range = this.range;

        if (value && (minDateMoment || maxDateMoment)) {
          if (range) return;

          var _hasDateBetweenMinMax = hasDateBetweenMinMaxDate(value, minDateMoment, maxDateMoment, range),
    ...
    emitValue: function emitValue(value) {
      ...
      if (this.range) {
        if (value) {
          ...
          valueToSend = {
            start: start instanceof external_moment_default.a ? start.format(this.format) : null,
            end: end instanceof external_moment_default.a ? end.format(this.format) : null
          };
        } else {
          valueToSend = null;
        }
      } else {
        valueToSend = value instanceof external_moment_default.a ? value.format(this.format) : null;
...
var _mainvue_type_template_id_0022c02d_render = function() {
  ...
  return _c(
    "div",
    {
      ...
      class: [{ "maz-is-dark": _vm.dark }, _vm.size],
      attrs: { id: _vm.id }
    },
    [
...
// EXTERNAL MODULE: external "libphonenumber-js/max"
var max_ = __webpack_require__(3);
...
var isCountryAvailable = /*#__PURE__*/function () {
  var _ref = MazPhoneNumberInput_mainvue_type_script_lang_js_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee(locale) {
    return regenerator_default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 3:
            throw "MazPhoneNumberInput: The locale ".concat(locale, " is not available");
...
/* harmony default export */ var MazPhoneNumberInput_mainvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    countryCode: {
      ...
      set: function set(countryCode) {
        ...
        var buildResults = this.buildResults,
            $refs = this.$refs,
            asYouTypeNumber = this.asYouTypeNumber;
        buildResults({
    ...
    callingCode: function callingCode() {
      var countryCode = this.countryCode;
      return countryCode ? "+".concat(Object(max_["getCountryCallingCode"])(countryCode)) : null;
    },
    ...
    phoneNumberExample: function phoneNumberExample() {
      var phoneNumber = this.countryCode ? Object(max_["getExampleNumber"])(this.countryCode, examples_mobile_json_default.a) : null;
    ...
    countriesList: function countriesList() {
      ...
      return this.codesCountries.filter(function (item) {
  ...
  mounted: function mounted() {
    ...
    return MazPhoneNumberInput_mainvue_type_script_lang_js_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee2() {
      var defaultCountryCode, fetchCountry, noUseBrowserLocale, fetchCountryCode, setLocale;
      return regenerator_default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              defaultCountryCode = _this4.defaultCountryCode, fetchCountry = _this4.fetchCountry, noUseBrowserLocale = _this4.noUseBrowserLocale, fetchCountryCode = _this4.fetchCountryCode, setLocale = _this4.setLocale;
            ...
            case 8:
              fetchCountry ? fetchCountryCode() : !noUseBrowserLocale ? setLocale(browserLocale()) : null;

              _this4.buildResults({
                phoneNumber: _this4.value,
                countryCode: _this4.countryCode
              });
  ...
  methods: {
    getAsYouTypeFormat: function getAsYouTypeFormat(_ref2) {
      var countryCode = _ref2.countryCode,
          phoneNumber = _ref2.phoneNumber;
      if (!phoneNumber) return this.asYouTypeNumber = null;
      this.asYouTypeNumber = phoneNumber ? new max_["AsYouType"](countryCode).input(phoneNumber) : null;
    },
    getParsePhoneNumberFromString: function getParsePhoneNumberFromString(_ref3) {
      var _this5 = this;
      ...
      return MazPhoneNumberInput_mainvue_type_script_lang_js_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee3() {
        var phoneNumber, countryCode, parsing;
        return regenerator_default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                phoneNumber = _ref3.phoneNumber, countryCode = _ref3.countryCode;
                _context3.prev = 1;
                parsing = phoneNumber && countryCode ? Object(max_["parsePhoneNumberFromString"])(phoneNumber, countryCode) : null;
                _this5.results = MazPhoneNumberInput_mainvue_type_script_lang_js_objectSpread(MazPhoneNumberInput_mainvue_type_script_lang_js_objectSpread({
                  countryCode: countryCode,
                  isValid: false
                }, phoneNumber && phoneNumber !== '' ? {
                  phoneNumber: phoneNumber
              ...
              case 6:
                ...
                return _context3.abrupt("return", new Error('MazPhoneNumberInput: Impossible to parse phone number'));
    ...
    buildResults: function buildResults(payload) {
      var _this6 = this;
      ...
      return MazPhoneNumberInput_mainvue_type_script_lang_js_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee4() {
        var asYouTypeNumber, lastKeyPressed, getParsePhoneNumberFromString, getAsYouTypeFormat, backSpacePressed, lastCharacOfPhoneNumber, _this6$results, isValid, e164, phoneNumber;

        return regenerator_default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                asYouTypeNumber = _this6.asYouTypeNumber, lastKeyPressed = _this6.lastKeyPressed, getParsePhoneNumberFromString = _this6.getParsePhoneNumberFromString, getAsYouTypeFormat = _this6.getAsYouTypeFormat;
              ...
              case 8:
                _context4.next = 10;
                return getParsePhoneNumberFromString(payload);

              case 10:
                _context4.next = 12;
                return getAsYouTypeFormat(MazPhoneNumberInput_mainvue_type_script_lang_js_objectSpread(MazPhoneNumberInput_mainvue_type_script_lang_js_objectSpread({}, payload), {}, {
                  phoneNumber: payload.countryCode === 'RU' ? _this6.results.isValid ? _this6.results.formatNational : payload.phoneNumber : _this6.results.formatNational || payload.phoneNumber
                }));
              ...
              case 12:
                ...
                _this6$results = _this6.results, isValid = _this6$results.isValid, e164 = _this6$results.e164, phoneNumber = _this6$results.phoneNumber; // sent when the user tape
                // @arg Phone number value formatted in e164 format (international format)

                _this6.$emit('input', isValid ? e164 : phoneNumber);
    ...
    setLocale: function setLocale(locale) {
      var buildResults = this.buildResults,
          asYouTypeNumber = this.asYouTypeNumber;
      var countryAvailable = isCountryAvailable(locale);

      if (countryAvailable && locale) {
        this.userLocale = locale;
        if (!this.hasEmptyPhone) buildResults({
          countryCode: locale,
          phoneNumber: asYouTypeNumber
        });
      }
    },
    fetchCountryCode: function fetchCountryCode() {
      var _this7 = this;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 6:
                ...
                if (result && result[0] === '1') _this7.setLocale(result.substr(2, 2));
                _context5.next = 14;
                break;
              ...
              case 11:
                ...
                return _context5.abrupt("return", new Error('[MazPhoneNumberInput] Error while fetching country code'));
    ...
    focusCountrySelector: function focusCountrySelector() {
      ...
      return MazPhoneNumberInput_mainvue_type_script_lang_js_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee6() {
...
var _mainvue_type_template_id_c5d051bc_render = function() {
  ...
  return _c(
    "div",
    {
      ...
      class: [{ "maz-is-dark": _vm.dark }, "maz-search--" + _vm.color],
      on: {
        "!blur": function($event) {
          return _vm.closeList($event)
        }
                      ...
                      class: [
                        {
                          selected:
                            _vm.value ===
                            (_vm.itemValue ? item[_vm.itemValue] : item)
                        },
                        {
                          "keyboard-selected":
                            _vm.tmpValue ===
                    ...
                    [
                      _vm._t(
                        ...
                        [
                          _c("p", [
                            _vm._v(
                              _vm._s(_vm.itemText ? item[_vm.itemText] : item)
                            )
                          ])
                        ],
                        { item: item, tag: "div" }
                ...
                _vm.hasNoDataSlot
                  ? _vm._t(
                      ...
                      [
                        _c(
                          "div",
                          { staticClass: "maz-p-1 maz-flex maz-flex-center" },
                          [
                            _c(
                              "i",
                              { staticClass: "material-icons maz-text-danger" },
...
function MazSearch_mainvue_type_script_lang_js_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function MazSearch_mainvue_type_script_lang_js_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { MazSearch_mainvue_type_script_lang_js_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { MazSearch_mainvue_type_script_lang_js_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
/* harmony default export */ var MazSearch_mainvue_type_script_lang_js_ = ({
  ...
  computed: {
    tmpValueIndex: function tmpValueIndex() {
      ...
      return this.items.findIndex(function (c) {
        return (_this.itemValue ? c[_this.itemValue] : c) === _this.tmpValue;
      });
    },
    selectedValueIndex: function selectedValueIndex() {
      var _this2 = this;

      return this.value ? this.items.findIndex(function (c) {
        return (_this2.itemValue ? c[_this2.itemValue] : c) === _this2.value;
      }) : null;
    },
  ...
  methods: {
    ...
    reset: function reset() {
      ...
      return MazSearch_mainvue_type_script_lang_js_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this3.closeList(); // this.query = null
    ...
    updateValue: function updateValue(item) {
      ...
      return MazSearch_mainvue_type_script_lang_js_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee2() {
        return regenerator_default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
    ...
    scrollToSelectedOnFocus: function scrollToSelectedOnFocus(arrayIndex) {
      ...
      this.$nextTick(function () {
        var itemHeight = _this5.$refs.item && _this5.$refs.item[0] && _this5.$refs.item[0].clientHeight;
        if (_this5.$refs.itemsList) _this5.$refs.itemsList.scrollTop = arrayIndex * itemHeight - itemHeight;
      });
    },
    keyboardNav: function keyboardNav(e) {
          ...
          _vm._l(_vm.computedValue, function(btn, i) {
            return _c(
              "button",
              {
                ...
                class: {
                  "active-cursor": i === _vm.activeCursor
                },
                style: [_vm.buttonStyles[i]],
                attrs: {
                  tabindex: "-1",
                  type: "button",
                  "data-label": _vm.getLabel(i)
                },
                on: {
...
/* harmony default export */ var MazSlider_mainvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    wrapperStyle: function wrapperStyle() {
      var labels = this.labels,
          sizeValue = this.sizeValue;
      return {
        padding: "".concat(sizeValue * 1.5, "px ").concat(sizeValue * 5.5, "px"),
  ...
  mounted: function mounted() {
    ...
    this.buildComponent();
    window.addEventListener('resize', this.buildComponent); // watch multiples values
  ...
  methods: {
        ...
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this2.checkValues();

              case 2:
                _context.next = 4;
                return _this2.calcPos();
              ...
              case 6:
                _this2.computedValue.forEach(function (b, i) {
                  return _this2.setBtnDividers(i);
                });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                min = _this3.min, max = _this3.max, computedValue = _this3.computedValue;
                valuesChecked = computedValue.map(function (v) {
                  return v < min ? min : v > max ? max : v;
                });

                _this3.emitValue(valuesChecked);

                _this3.tmpValues = valuesChecked;
    ...
    emitValue: function emitValue(values) {
      var value = this.value;
      var valueToEmit = typeof value === 'number' ? values[0] : values;
      this.$emit('input', valueToEmit);
    },
    ...
    setBtnStyle: function setBtnStyle(i) {
      ...
      return MazSlider_mainvue_type_script_lang_js_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee3() {
        var height, buttonPositions, Cursor, width, isActive, btnStyle;
        return regenerator_default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                height = _this4.buttonSize.height;
                buttonPositions = _this4.buttonPositions;
                Cursor = _this4.$refs.Cursor; // get width of text in cursor + padding/space

                width = Cursor[i].querySelector('span').clientWidth + 16;
                isActive = i === _this4.activeCursor;
                btnStyle = {
                  // 16 = space for arrows
                  width: "".concat(isActive ? width + 16 : width, "px"),
                  height: "".concat(height, "px"),
                  left: "".concat(buttonPositions[i] - width / 2, "px")
                };

                _this4.$set(_this4.buttonStyles, i, btnStyle);
        ...
        return regenerator_default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                MazSlider = _this5.$refs.MazSlider;
                tmpValues = _this5.tmpValues, min = _this5.min, scale = _this5.scale, range = _this5.range, minLog = _this5.minLog, max = _this5.max, log = _this5.log;
                barWidth = MazSlider.clientWidth;
                _this5.buttonPositions = tmpValues.map(function (v) {
    ...
    getCursorsValues: function getCursorsValues() {
      var range = this.range,
          ...
          minLog = this.minLog,
          log = this.log;
      var barWidth = this.$refs.MazSlider.clientWidth;
      return log ? buttonPositions.map(function (pos) {
    ...
    handleMouseup: function handleMouseup() {
      var activeCursor = this.activeCursor;
      if (activeCursor === null) return; // emit values of cursors
    ...
    handleMousemove: function handleMousemove(e) {
      ...
      var barWidth = this.$refs.MazSlider.clientWidth;
      var position = buttonPositions[activeCursor];
      var prevValue = buttonPositions[activeCursor - 1] || 0;
      var nextValue = buttonPositions[activeCursor + 1] || barWidth;
    ...
    _vm._l(_vm.stepsNumber, function(step, i) {
      return _c(
        "MazBtn",
        {
          ...
          style: [_vm.stepStyle],
          attrs: { "no-shadow": !_vm.shadow, color: _vm.color },
          on: {
            click: function($event) {
...
var _mainvue_type_template_id_4b0caca4_render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "maz-base-component maz-switch" }, [
    _c(
      "input",
      _vm._b(
        {
...
function MazTabsBar_mainvue_type_script_lang_js_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function MazTabsBar_mainvue_type_script_lang_js_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { MazTabsBar_mainvue_type_script_lang_js_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { MazTabsBar_mainvue_type_script_lang_js_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
/* harmony default export */ var MazTabsBar_mainvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    getTabsIndicatorState: function getTabsIndicatorState() {
      ...
      return MazTabsBar_mainvue_type_script_lang_js_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
...
var external_resize_observer_polyfill_ = __webpack_require__(11);
...
function _createForOfIteratorHelper(o, allowArrayLike) { var it; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it = MazTabsContent_mainvue_type_script_lang_js_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = o[Symbol.iterator](); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }

function MazTabsContent_mainvue_type_script_lang_js_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return MazTabsContent_mainvue_type_script_lang_js_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return MazTabsContent_mainvue_type_script_lang_js_arrayLikeToArray(o, minLen); }

function MazTabsContent_mainvue_type_script_lang_js_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function MazTabsContent_mainvue_type_script_lang_js_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function MazTabsContent_mainvue_type_script_lang_js_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { MazTabsContent_mainvue_type_script_lang_js_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { MazTabsContent_mainvue_type_script_lang_js_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
/* harmony default export */ var MazTabsContent_mainvue_type_script_lang_js_ = ({
  ...
  watch: {
    currentTab: {
      handler: function handler() {
        ...
        return MazTabsContent_mainvue_type_script_lang_js_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
  ...
  methods: {
    resizeObserver: function resizeObserver() {
      ...
      return MazTabsContent_mainvue_type_script_lang_js_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee2() {
